<?php /* Smarty version Smarty-3.0.8, created on 2017-05-24 09:56:16
         compiled from "D:\phpStudy\WWW\guoxun\system/templates/admin/content_list.html" */ ?>
<?php /*%%SmartyHeaderCode:29025924e8408eb602-05470019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b48af54feaafd470eb91080199b6e0e29b67246' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\guoxun\\system/templates/admin/content_list.html',
      1 => 1481072925,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29025924e8408eb602-05470019',
  'function' => 
  array (
  ),
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="xdcms_table">
  <tr>
    <th colspan="7" class="title"><div class="title_nav_1"><?php echo $_smarty_tpl->getVariable('catname')->value;?>
...
')">删除</a></td>
  ...
  <tr>
	<td colspan="7"><input type="hidden" name="catid" id="catid" value="<?php echo $_smarty_tpl->getVariable('catid')->value;?>
" /><input name="submit" type="submit" class="submit ml20" value="批量删除" onclick="form.action='index.php?m=xdcms&c=content&f=delete';" /><input name="submit" type="submit" class="button ml20" value="排序" onclick="form.action='index.php?m=xdcms&c=content&f=sort_save';" /><input name="submit2" type="submit" class="submit ml20" value="批量移动" onclick="form.action='index.php?m=xdcms&c=transfer&f=transfer_content';" /></td>
 ...
 <tr class="bf">
    <td colspan="7" class="tc"><?php echo $_smarty_tpl->getVariable('pages')->value;?>
</td></tr>
</table>
</form>
