<?php /* Smarty version Smarty-3.0.8, created on 2017-05-24 09:49:45
         compiled from "D:\phpStudy\WWW\guoxun\system/templates/xdcms/list_job.html" */ ?>
<?php /*%%SmartyHeaderCode:125565924e6b98f60c6-38431736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ddec7e69532b510315ad19489596a38d903c291' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\guoxun\\system/templates/xdcms/list_job.html',
      1 => 1481072921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '125565924e6b98f60c6-38431736',
  'function' => 
  array (
  ),
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    <div id="body3_r">
      <div class="body3_r1">
        ...
        <div class="body3_r2">
        <!-- 文本 -->
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'more'=>1,'pages'=>'page','rows'=>3)); $_block_repeat=true; smarty_block_loop(array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'more'=>1,'pages'=>'page','rows'=>3), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
人</td>
        ...
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_loop(array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'more'=>1,'pages'=>'page','rows'=>3), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
