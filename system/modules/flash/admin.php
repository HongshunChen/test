...
class admin extends Checklogin{
	...
	public function editsave(){
		...
		$this->mysql->db_update('flash',"`title`='".$title."',`typeid`='".$typeid."',`url`='".$url."',`thumb`='".$thumb."'",'`id`='.$id);
	...
	public function addsave(){
		...
		$this->mysql->db_insert('flash',"`title`='".$title."',`typeid`='".$typeid."',`url`='".$url."',`thumb`='".$thumb."',`inputtime`='".datetime()."',`is_lock`=0");
		$this->creat_xml($typeid);
